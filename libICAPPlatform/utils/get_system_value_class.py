...
class get_system_value() :
    ...
    def __get_Module_spec(self):
        ...
        elif "Xavier-NX" in self.__module_name:
            spec = ["Xavier-NX","Volta","10.2","7.2","384","LPDDR4x","128-bit","8 GB","51.2 GB/s","1109 MHz","1109MHz"]
        elif "Xavier" in self.__module_name:
            spec = ["Xavier-NX","Volta","10.2","7.2","512","LPDDR4x","256-bit","32 GB","136.5 GB/s","1109 MHz","2133MHz"]
        else:
            spec = []
